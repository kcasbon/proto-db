...
abstract class BPlusNode {
    ...
    /**
     * Helper function to abstract the process of splitting an inner or leaf node.
     * Returns (key, rid) pair upon which the nodes were split.
     */
    public abstract Optional<Pair<DataBox, Long>> splitNode();
